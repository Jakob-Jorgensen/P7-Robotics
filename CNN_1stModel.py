...
sample_rgb = rgb_val[3:18]  # Take 5 RGB images (indices 5 to 9)
sample_depth = depth_val[3:18]  # Corresponding Depth images
sample_saliency = saliency_val[3:18]  # Corresponding Ground Truth saliency maps
